  ...
  const tier4_perception_msgs::msg::DetectedObjectsWithFeature::ConstSharedPtr input_msg)
{
  ...
  auto transform_stamp_opt = managed_tf_buffer_.getTransform<geometry_msgs::msg::TransformStamped>(
    ...
    rclcpp::Duration::from_seconds(0), this->get_logger());
  ...
  auto min_ranged_transformed =
    autoware::universe_utils::transformPose(min_range, *transform_stamp_opt);
  auto max_range_transformed =
    autoware::universe_utils::transformPose(max_pose, *transform_stamp_opt);
